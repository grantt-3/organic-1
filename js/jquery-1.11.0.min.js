...
!(function (a, b) {
    ...
    function K() {
        (z.addEventListener || "load" === event.type || "complete" === z.readyState) &&
            (J(), n.ready());
    }
                ...
                while ((f = h[b++]) && !a.isPropagationStopped()) {
                    ...
                    while ((e = f.handlers[g++]) && !a.isImmediatePropagationStopped())
                        (!a.namespace_re || a.namespace_re.test(e.namespace)) &&
                            ((a.handleObj = e),
                            (a.data = e.data),
                            (c = ((n.event.special[e.origType] || {}).handle || e.handler).apply(
                                f.elem,
                                i
                            )),
                            void 0 !== c &&
        ...
        function k() {
            ...
            h &&
                ...
                a.getComputedStyle &&
                    ...
                    (e = "4px" === (a.getComputedStyle(c, null) || { width: "4px" }).width)),
                h.removeChild(b),
                (c = h = null));
        }
    })(),
