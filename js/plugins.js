    ...
    function n(a) {
        ...
        function c(a) {
            for (var b = 0, c = {}, d = f.animations, e = {}; b < d.length; ) {
                ...
                e.eased = e.tween.easing(
                    Math.min(Math.max(a - e.tween.start - e.tween.delay, 0), e.tween.duration) /
                        e.tween.duration,
                    e.tween.elasticity
                );
                m = Y(
        ...
        function h(a) {
            ...
            r > l && r < h
                ...
                : (r <= l && 0 !== P && (c(0), q && g()), r >= h && P !== h && (c(h), q || g()));
            a >= h &&
                (f.remaining
    ...
    class o {
        constructor(e, t) {
            (this.settings = t),
                ...
                NodeList.prototype.isPrototypeOf(e) || HTMLCollection.prototype.isPrototypeOf(e)
                    ? e.forEach((e, t) => {
                          this.images.push({
        ...
        position({ naturalHeight: e, naturalWidth: s }) {
            ...
            return t(() => {
                Object.assign(this.elems.imageWrapper.style, { width: n + "px", height: a + "px" });
